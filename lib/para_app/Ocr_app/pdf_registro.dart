...
class Pdf_registro extends StatelessWidget {
  final String texto;
  final Map<String, dynamic> datos;
  final File file;
  final List<Map<String, String>> resultados;

  Pdf_registro({required this.texto, required this.datos, required this.file, required this.resultados});
  ...
  Future<void> subirAFirebaseStorage(File archivo, Map<String, dynamic> datos,List<Map<String, String>> resultados) async {
    ...
    Map<String, dynamic> subir = {
      ...
      'fecha_de_emision': resultados[0]['Fecha Emisión'],
